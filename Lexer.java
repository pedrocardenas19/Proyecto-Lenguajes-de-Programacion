...
public class Lexer{
	...
	public static final int ADDITION = 18; //added
	public static final int DIFFERENT=19; //added
	public static final int MULTIPLY = 20; //added
	public static final int WHILE = 21; //added
	public static final int ENDWHILE = 22; //added
	...
	**/
	public Lexer (String fileName) throws FileNotFoundException {
		...
		keywordsTable.add(new Token(ASSIGN, "=", 0)); //added
		keywordsTable.add(new Token(ADDITION, "+", 0)); //added
		keywordsTable.add(new Token(DIFFERENT, "!=", 0)); //added
		keywordsTable.add(new Token(MULTIPLY, "*", 0));	//added
		keywordsTable.add(new Token(WHILE, "while", 0)); //added
		keywordsTable.add(new Token(ENDWHILE, "endcycle", 0)); //added
